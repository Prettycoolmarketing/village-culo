  ...
  return (
    <main className="min-h-screen bg-background">
      <section className="bg-charcoal py-16 md:py-20">
        <InnerContainer>
          <h1 className="font-heading text-4xl sm:text-5xl font-bold text-white leading-tight mb-3">
            Terms &amp; Conditions
          </h1>
          <p className="font-body text-white/60 text-sm">Last updated {LAST_UPDATED} · Governed by the laws of Queensland, Australia</p>
        </InnerContainer>
      </section>
