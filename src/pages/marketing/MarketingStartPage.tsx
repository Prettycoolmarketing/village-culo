...
export function MarketingStartPage() {
  ...
  return (
    <main className="min-h-screen bg-pcm-sand">
      <section className="bg-pcm-dark py-20 md:py-24 text-center">
        <InnerContainer className="max-w-2xl">
          ...
          <p className="font-body text-lg text-white/70 leading-relaxed">
            ...
            <a href={`mailto:${PCM_SUPPORT_EMAIL}`} className="text-white underline hover:text-pcm-orange">
              {PCM_SUPPORT_EMAIL}
            </a>
            .
          </p>
      ...
      <section className="py-16 md:py-20">
        <InnerContainer className="max-w-3xl">
          ...
          <div className="bg-white border border-pcm-linen rounded-2xl p-8 shadow-card">
            <p className="font-body text-sm text-pcm-muted mb-1">Send to</p>
            <p className="font-heading text-xl font-bold text-pcm-ink mb-5">{PCM_SUPPORT_EMAIL}</p>
            <a
              href={mailto}
          ...
          <p className="mt-8 font-body text-sm">
            <Link to="/marketing" className="text-pcm-orange hover:underline">← Back to Pretty Cool Marketing</Link>
          </p>
        </InnerContainer>
      </section>
    </main>
